...
void display()
{
    printf("                Welcome to TEK-UP Restaurant.          \n ");
    printf("             +============================+          \n\n");
...
void display_bfmenu()
{
    ...
    printf("\t\t   [0] Toast - DT 30.00\n");
    printf("\t\t   [1] Idli-Vada - DT 35.00\n");
    printf("\t\t   [2] Dosa - DT 40.00\n");
    printf("\t\t   [3] UPMA DT 20.00\n");
    printf("\t\t   [4] Milk- DT 15.00\n");
    printf("\t\t   [5] Tea - DT 20.00\n");
    printf("\t\t   [6] Coffee - DT 30.00\n");
}
...
void display_bf_bill(char bfmenu[][100])
{
    int i;
    printf("  +~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+          \n\n");
    printf("                     TEK-UP  RESTAURANT                   \n");
    printf("                    BILLING INFORMATION                \n");
    printf("\t\t ITEMS\t\tPrice(in DT.)\n");
    for(i=0;i<7;i++)
    {
        if(purchased[i][1]!=0)
        {
